...
sst <- ggplot() + 
  ...
  annotate(geom="text", x=0, y=1.85, label="Crypto", hjust=0, size=3, color="navy", fontface = "bold")+
  annotate(geom="text", x=0, y=1.7, label="Large fish", hjust=0, size=3, color="darkgreen", fontface = "bold")+
  labs(x="mean SST", y="log10(MOTUs richness+1)")+
  theme_bw() +
  theme(axis.line = element_line(colour = "black"),
        legend.position = "right",             # position in top left corner
        legend.title = element_blank(),
...
volume <- ggplot() + 
  ...
  annotate(geom="text", x=0.7, y=2, label="all MOTUs", hjust=0, size=3, color="darkred", fontface = "bold")+
  #annotate(geom="text", x=1.6, y=4.3, label="Chondri", hjust=0, size=4, color="orange", fontface = "bold")+
  annotate(geom="text", x=0.7, y=1.85, label="Crypto", hjust=0, size=3, color="navy", fontface = "bold")+
  annotate(geom="text", x=0.7, y=1.7, label="Large fish", hjust=0, size=3, color="darkgreen", fontface = "bold")+
  labs(x="log10(volume (L) +1)", y="log10(MOTUs richness+1)")+
  theme_bw() +
  theme(axis.line = element_line(colour = "black"),
        legend.position = "right",             # position in top left corner
        legend.title = element_blank(),
...
depthsamp <- ggplot() + 
  ...
  annotate(geom="text", x=1.6, y=2, label="all MOTUs", hjust=0, size=4, color="darkred", fontface = "bold")+
  #annotate(geom="text", x=1.6, y=4.3, label="Chondri", hjust=0, size=4, color="orange", fontface = "bold")+
  annotate(geom="text", x=1.6, y=1.9, label="Crypto", hjust=0, size=4, color="navy", fontface = "bold")+
  annotate(geom="text", x=1.6, y=1.8, label="Large fish", hjust=0, size=4, color="darkgreen", fontface = "bold")+
  labs(x="depth of sampling (m)", y="log10(MOTUs richness+1)")+
  theme_bw() +
  theme(axis.line = element_line(colour = "black"),
        legend.position = "right",             # position in top left corner
        legend.title = element_blank(),
