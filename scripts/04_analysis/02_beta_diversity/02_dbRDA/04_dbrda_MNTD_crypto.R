...
load("Rdata/MNTD_crypto_pairwise_station.rdata")
...
dbrda_part <- capscale(mntd_crypto ~ mean_DHW_1year+mean_DHW_5year+mean_SST_1year+mean_sss_1year+mean_npp_1year+Corruption_mean+HDI2019+Gravity+MarineEcosystemDependency+conflicts+dist_to_CT+bathy+depth_sampling+distCoast +Condition(volume+MEM1), df_mem) 
...
partition <- data.frame(environment=0.128+0.053+0.069, 
                        geography=0.045+0.053+0.041, 
                        socioeconomy=0.069+0.041+0.051)
