...
dbrda_MPD_MED <- ggplot(station_scores_met, aes(x= CAP1, y = CAP2)) +
  ...
  theme(axis.line = element_line(colour = "black"),
        legend.position = "bottom",             # position in top left corner
...
save(dbrda_MPD_MED, file="Rdata/dbrda_MPD_MED.rdata")
