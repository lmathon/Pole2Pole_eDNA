...
save(gls.MNTD, file="Rdata/gls_mntd.rdata")
...
fit.DHW.MNTD <- visreg(gls.MNTD,"mean_DHW_1year",scale="response")
...
partition <- data.frame(environment=0.117+0.02+0.101+0.177+0.144+0.26, 
                        geography=0.129+0.138+0.02+0.177+0.153, 
                        socioeconomy=0.058+0.138+0.079+0.177+0.144+0.101, 
                        sampling=0.031+0.079+0.177+0.144+0.153+0.026)
