...
gravity <- ggplot() + 
  ...
  geom_line(data=fit.grav.MPD$fit, aes(Gravity, visregFit*b), colour='orange', size=1, show.legend = T)+
  geom_ribbon(data=fit.grav.MPD$fit, aes(x=Gravity, ymin=visregLwr*b, ymax=visregUpr*b), fill='orange', alpha=.2)+
  ...
  scale_y_continuous("log10(MOTUs richness+1)", sec.axis = sec_axis(~ (. - a)/b, name = "MPD")) +
  theme_bw() +
...
sst <- ggplot() + 
  ...
  geom_line(data=fit.SST.MPD$fit, aes(mean_SST_1year, visregFit*b), colour='orange', size=1, show.legend = T)+
  geom_ribbon(data=fit.SST.MPD$fit, aes(x=mean_SST_1year, ymin=visregLwr*b, ymax=visregUpr*b), fill='orange', alpha=.2)+
...
sss <- ggplot() + 
  ...
  geom_line(data=fit.SSS.MPD$fit, aes(mean_sss_1year, visregFit*b), colour='orange', size=1, show.legend = T)+
  geom_ribbon(data=fit.SSS.MPD$fit, aes(x=mean_sss_1year, ymin=visregLwr*b, ymax=visregUpr*b), fill='orange', alpha=.2)+
...
med <- ggplot() + 
  ...
  geom_line(data=fit.MED.MPD$fit, aes(MarineEcosystemDependency, visregFit*b), colour='orange', size=1, show.legend = T)+
  geom_ribbon(data=fit.MED.MPD$fit, aes(x=MarineEcosystemDependency, ymin=visregLwr*b, ymax=visregUpr*b), fill='orange', alpha=.2)+
...
distCT <- ggplot() + 
  ...
  geom_line(data=fit.CT.MPD$fit, aes(dist_to_CT, visregFit*b), colour='orange', size=1, show.legend = T)+
  geom_ribbon(data=fit.CT.MPD$fit, aes(x=dist_to_CT, ymin=visregLwr*b, ymax=visregUpr*b), fill='orange', alpha=.2)+
...
distcoast <- ggplot() + 
  ...
  geom_line(data=fit.coast.MPD$fit, aes(distCoast, visregFit*b), colour='orange', size=1, show.legend = T)+
  geom_ribbon(data=fit.coast.MPD$fit, aes(x=distCoast, ymin=visregLwr*b, ymax=visregUpr*b), fill='orange', alpha=.2)+
...
volume <- ggplot() + 
  ...
  geom_line(data=fit.vol.MPD$fit, aes(volume, visregFit*b), colour='orange', size=1, show.legend = T)+
  geom_ribbon(data=fit.vol.MPD$fit, aes(x=volume, ymin=visregLwr*b, ymax=visregUpr*b), fill='orange', alpha=.2)+
...
depthsamp <- ggplot() + 
  ...
  geom_line(data=fit.samp.MPD$fit, aes(depth_sampling, visregFit*b), colour='orange', size=1, show.legend = T)+
  geom_ribbon(data=fit.samp.MPD$fit, aes(x=depth_sampling, ymin=visregLwr*b, ymax=visregUpr*b), fill='orange', alpha=.2)+
...
dhw5 <- ggplot() + 
  ...
  geom_line(data=fit.DHW.MPD$fit, aes(mean_DHW_5year, visregFit*b), colour='orange', size=1, show.legend = T)+
  geom_ribbon(data=fit.DHW.MPD$fit, aes(x=mean_DHW_5year, ymin=visregLwr*b, ymax=visregUpr*b), fill='orange', alpha=.2)+
