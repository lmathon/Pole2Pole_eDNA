...
effectsize$Parameter <- gsub("mean_SST_1year", "mean SST", effectsize$Parameter)
effectsize$Parameter <- gsub("mean_sss_1year", "mean SSS", effectsize$Parameter)
effectsize$Parameter <- gsub("mean_npp_1year", "mean NPP", effectsize$Parameter)
effectsize$Parameter <- gsub("mean_DHW_1year", "mean DHW", effectsize$Parameter)
effectsize$Parameter <- gsub("HDI2019", "HDI", effectsize$Parameter)
effectsize$Parameter <- gsub("Gravity", "Human gravity", effectsize$Parameter)
