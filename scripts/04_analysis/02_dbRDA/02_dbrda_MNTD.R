...
dbrda_part <- capscale(mntd ~ mean_DHW_5year+mean_sss_1year+mean_SST_1year+mean_npp_1year+HDI2019+neartt+Gravity+MarineEcosystemDependency+Naturalresourcesrents+dist_to_CT+bathy+depth_sampling+latitude+distCoast+mean_DHW_1year + Condition(volume+sample_method+sequencer), df_sel) #MEM1+MEM2+MEM3+MEM4+MEM5+
